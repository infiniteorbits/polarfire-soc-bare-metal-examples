...
static cif_core_mmcresponse_t set_mmc_clk_div(const mmc_instance_t *this_mmc);
static cif_core_mmcresponse_t set_mmc_dwidth(const mmc_instance_t *this_mmc);
...
mmc_transfer_status_t MMC_init(mmc_instance_t *this_mmc, addr_t base_address,
  ...
  cif_core_mmcresponse_t response_status;
  ...
  if (MMC_TRANSFER_SUCCESS == ret_status) {
     ...
     */
    response_status =
        cif_core_mmcsend_core_mmc_cmd(this_mmc->base_addr, RESET_ARG, MMC_CMD_0_GO_IDLE_STATE);
    delay = 0xFFFFU;
    while (delay) {
      delay--;
    }
...
mmc_transfer_status_t MMC_single_block_write(const mmc_instance_t *this_mmc,
  ...
  do {
    response_status =
        cif_core_mmcsend_core_mmc_cmd(this_mmc->base_addr, RCA_VALUE, MMC_CMD_13_SEND_STATUS);
   ...
   */
  response_status = cif_core_mmcsend_core_mmc_cmd(this_mmc->base_addr, dst_addr,
...
mmc_transfer_status_t MMC_single_block_write_nb(mmc_instance_t *this_mmc,
  ...
  send_core_mmc_cmd(this_mmc->base_addr, RCA_VALUE, MMC_CMD_13_SEND_STATUS,
...
mmc_transfer_status_t MMC_single_block_read(const mmc_instance_t *this_mmc,
  ...
  if (READ_SEND_EXT_CSD == src_addr) {
    response_status =
        cif_core_mmcsend_core_mmc_cmd(this_mmc->base_addr, 0U, MMC_CMD_8_SEND_EXT_CSD);
  } else {
    response_status = cif_core_mmcsend_core_mmc_cmd(this_mmc->base_addr, src_addr,
  ...
  if (!(ISR_BISR_MBSIR_ERR & isr_errors)) /* Abort if any errors*/
  {
    ...
    if (NO_ERROR == read_err_isr) {
       ...
       */
      do {
        response_status = cif_core_mmcsend_core_mmc_cmd(this_mmc->base_addr, RCA_VALUE,
...
static cif_core_mmcresponse_t set_mmc_dwidth(const mmc_instance_t *this_mmc) {
  ...
  response_status = cif_core_mmcsend_core_mmc_cmd(
      this_mmc->base_addr,
...
static void get_card_sector_size(mmc_instance_t *this_mmc) {
  ...
  cif_core_mmcresponse_t ret_val;

  ret_val = cif_core_mmcsend_core_mmc_cmd(this_mmc->base_addr, RCA_VALUE, MMC_CMD_9_SEND_CSD);
...
static cif_core_mmcresponse_t set_mmc_clk_div(const mmc_instance_t *this_mmc) {
  ...
  if (TRANSFER_IF_SUCCESS == response_status) {
    response_status =
        cif_core_mmcsend_core_mmc_cmd(this_mmc->base_addr, MMC_HS_MODE, MMC_CMD_6_SWITCH);
  }
...
static mmc_transfer_status_t oper_cond_config(const mmc_instance_t *this_mmc) {
  ...
  do {
    response_status =
        cif_core_mmcsend_core_mmc_cmd(this_mmc->base_addr, OP_COND, MMC_CMD_1_SEND_OP_COND);
...
static mmc_transfer_status_t data_transfer_config(mmc_instance_t *this_mmc) {
  ...
  volatile cif_core_mmcresponse_t response_status;
...
static mmc_transfer_status_t dev_addr_config(const mmc_instance_t *this_mmc) {
  ...
  response_status =
      cif_core_mmcsend_core_mmc_cmd(this_mmc->base_addr, STUFF_BITS, MMC_CMD_2_ALL_SEND_CID);
  if (TRANSFER_IF_SUCCESS == response_status) {
    response_status = cif_core_mmcsend_core_mmc_cmd(this_mmc->base_addr, RCA_VALUE,
...
void MMC_isr(mmc_instance_t *this_mmc) {
  ...
  if (ISR_BISR_MBSIR_ERR & isr_flags) {
    ...
    case MMC_ISR_MW_PARSE_CMD13:
      ...
      send_core_mmc_cmd(this_mmc->base_addr, (uint32_t)(this_mmc->status.no_of_blks),
    ...
    case MMC_ISR_MW_PARSE_CMD23:
      ...
      send_core_mmc_cmd(this_mmc->base_addr, this_mmc->status.blk_addr,
    ...
    case MMC_ISR_EXT_CSD_PARSE_CMD13:
      ...
      if (MMC_ISR_SR_PARSE_CMD13 == this_mmc->status.int_state) {
        ...
        send_core_mmc_cmd(this_mmc->base_addr, 0, MMC_CMD_8_SEND_EXT_CSD,
                     CHECK_IF_CMD_SENT_NO);
      }
    ...
    case MMC_ISR_STOP_TRANSMISSION:
      ...
      else if (R1_ERR_RESP_MASK & MMC_Response) /* Error */
      {
        ...
        break;
                 ...
                 (CURRENT_STATE12_9_MASK & MMC_Response)) /* Wrong state */
      {
        send_core_mmc_cmd(this_mmc->base_addr, RCA_VALUE,
