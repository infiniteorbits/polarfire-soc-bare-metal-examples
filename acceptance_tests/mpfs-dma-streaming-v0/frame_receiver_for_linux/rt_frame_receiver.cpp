...
/// Linux build as:
///
/// g++ -fpermissive -std=c++17 frame_receiver.cpp -o frame_receiver -lsfml-graphics -lsfml-window -lsfml-system -lpcap -pthread
///
...
#else
		sf::RenderWindow window(sf::VideoMode(1024, 1024), "RFIM Image Display");
