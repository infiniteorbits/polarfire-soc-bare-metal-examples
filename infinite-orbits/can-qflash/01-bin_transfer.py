...
def send_data_from_wic_file(file_path, channel, can_id, small_delay, large_delay, large_delay_threshold=2048):
...
# Usage example
wic_file_path = 'mpfs-rpmsg-master_small.bin'  # Replace with the path to your payload file
can_channel = 'can0'
fixed_can_id = 0x00
small_delay_seconds = 0.0004
large_delay = 0.2
