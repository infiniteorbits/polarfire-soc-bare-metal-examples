...
tx_desc_ring_init(mss_mac_instance_t *this_mac)
{
    ...
    {
#if defined(MSS_MAC_USE_DDR)
        this_mac->queue[queue_no].tx_desc_tab = (mss_mac_tx_desc_t*)g_mss_mac_ddr_ptr;
...
rx_desc_ring_init(mss_mac_instance_t *this_mac)
{
    ...
    {
#if defined(MSS_MAC_USE_DDR)
        this_mac->queue[queue_no].rx_desc_tab = (mss_mac_rx_desc_t*)g_mss_mac_ddr_ptr;
